...
export default function ResetPasswordNested({ open }) {
  ...
  return (
    ...
    >
      <ListItemButton sx={{ marginTop: "-10px" }} onClick={handleClick}>
        ...
        {/* Primary修改对应的名字 */}
        {open && <ListItemText primary="Reset Password" sx={{ color: "#32475c99", marginLeft: "-15px" }} />}
      ...
      <Collapse in={open && openList} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 3 }}>
            ...
            <ListItemText primary="Reset Password v1" sx={{ marginLeft: "-22px" }} />
          </ListItemButton>
          <ListItemButton sx={{ pl: 3 }}>
            <ListItemIcon>
              <FiberManualRecordRoundedIcon sx={{ fontSize: "10px", color: "#32475c99" }} />
            </ListItemIcon>
            <ListItemText primary="Reset Password v2" sx={{ marginLeft: "-22px" }} />
          </ListItemButton>
        </List>
      </Collapse>
    </List>
