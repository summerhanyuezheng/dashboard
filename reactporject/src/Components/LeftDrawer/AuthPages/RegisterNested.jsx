...
export default function RegisterNested({ open }) {
  ...
  return (
    ...
    >
      <ListItemButton sx={{ marginTop: "-10px" }} onClick={handleClick}>
        ...
        {/* Primary修改对应的名字 */}
        {open && <ListItemText primary="Register" sx={{ color: "#32475c99", marginLeft: "-15px" }} />}
      ...
      <Collapse in={open && openList} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 3 }}>
            ...
            <ListItemText primary="Register v1" sx={{ marginLeft: "-22px" }} />
          </ListItemButton>
          <ListItemButton sx={{ pl: 3 }}>
            <ListItemIcon>
              <FiberManualRecordRoundedIcon sx={{ fontSize: "10px", color: "#32475c99" }} />
            </ListItemIcon>
            <ListItemText primary="Register v2" sx={{ marginLeft: "-22px" }} />
          </ListItemButton>
          <ListItemButton sx={{ pl: 3 }}>
            <ListItemIcon>
              <FiberManualRecordRoundedIcon sx={{ fontSize: "10px", color: "#32475c99" }} />
            </ListItemIcon>
            <ListItemText primary="Register Multi-Steps" sx={{ marginLeft: "-22px" }} />
          </ListItemButton>
        </List>
      </Collapse>
    </List>
